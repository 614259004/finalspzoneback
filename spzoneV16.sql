...
CREATE TABLE `sp_address` (
  `A_addressid` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `A_homenumber` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `A_province` int(5) NOT NULL,
  `A_district` int(5) NOT NULL,
  `A_canton` int(5) NOT NULL,
  `A_moo` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `A_postal_code` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `A_receive_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `A_phone` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `C_customerid` varchar(6) COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `sp_address` (`A_addressid`, `A_homenumber`, `A_province`, `A_district`, `A_canton`, `A_moo`, `A_postal_code`, `A_receive_name`, `A_phone`, `C_customerid`) VALUES
('AD0002', '76/18', 11, 138, 1113, '8', '20190', 'Jirayuk Sae-lim', '0955579838', 'CM0003'),
('AD0003', '76/18', 11, 138, 1113, '8', '20190', 'Jirayuk Sae-lim', '0955579838', 'CM0003'),
('AD0004', '76/18', 11, 138, 1113, '8', '20190', 'Jirayuk Sae-lim', '0955579838', 'CM0003'),
('AD0005', '76/18', 11, 142, 1166, '8', '20110', 'Jirayuk Sae-lim', '0955579838', 'CM0003'),
('AD0006', '76/18', 7, 102, 821, '8', '15110', 'Jirayuk Sae-lim', '0955579838', 'CM0003'),
('AD0007', '76/18', 15, 187, 1504, '8', '24160', 'Supicha Netsuwan', '0614711894', 'CM0003'),
('AD0008', '76/18', 13, 167, 1349, '6', '22160', 'จิรายุค แซ่ลิ้ม', '0614711894', 'CM0003'),
('AD0009', '19/13', 15, 186, 1501, '6', '24190', 'peerapat limsoypret', '0955579838', 'CM0007');
...
INSERT INTO `sp_brand` (`B_brandid`, `B_name`, `B_image`, `S_statusid`) VALUES
('BR0012', 'PBG', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2F1630515325-SPzone?alt=media&token=5417002e-7704-46c1-9be5-8450388821a7', 3),
('BR0013', 'Norm', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2F1630515378-SPzone?alt=media&token=5e08376d-2f9e-4c58-8db3-5ad513f1d533', 3),
('BR0014', 'MilkyBoy', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2F1630515592-SPzone?alt=media&token=95465d4b-a496-4751-bc6f-d422621e19b3', 3),
('BR0015', 'Jone500', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2F1630515244-SPzone?alt=media&token=f1a8ee63-49c9-4afc-87e0-79cbd0d4f027', 3),
('BR0016', 'Dote', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2F1630515474-SPzone?alt=media&token=ed5b823e-8f61-430b-8c25-dd6d01a87d77', 3),
('BR0017', 'Gusmob', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2F1630515713-SPzone?alt=media&token=6bb32220-3994-499f-9e2d-f4e34dd3a2a7', 3);
...
CREATE TABLE `sp_cart` (
  `Ca_cartid` int(11) NOT NULL,
  `P_productid` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `C_customerid` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `P_size` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `sp_cart` (`Ca_cartid`, `P_productid`, `C_customerid`, `P_size`, `Ca_amount`) VALUES
(188, 'PD0004', 'CM0007', 'L', 3);
...
CREATE TABLE `sp_category` (
  `Cg_categoryid` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `Cg_name` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `S_statusid` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `sp_category` (`Cg_categoryid`, `Cg_name`, `S_statusid`) VALUES
('CG0001', 'shirt-vintage', 3),
('CG0002', 'plant', 3),
('CG0003', 'hat', 3),
('CG0004', 'shirt', 3),
('CG0005', 'warm', 3),
...
CREATE TABLE `sp_customer` (
  ...
  `C_lastname` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `sp_customer`
--

INSERT INTO `sp_customer` (`C_customerid`, `C_name`, `C_lastname`, `C_tel`, `C_image`, `S_statusid`) VALUES
('CM0001', 'MJ', 'teerakanon', '0123456789', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2Fno_image.png?alt=media&token=964e11de-d35d-4a4a-b6b5-c3490d07c617', 2),
('CM0002', 'milk', 'gigi', '0123456789', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2Fno_image.png?alt=media&token=964e11de-d35d-4a4a-b6b5-c3490d07c617', 2),
('CM0003', 'Jirayuk', 'Sae-lim', '0614711894', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/profile%2F1632521861-SPzone?alt=media&token=ee5876a4-bd1d-4eae-acd2-e72612ff45bf', 2),
('CM0004', 'Admin Spzone', '-', '0000000000', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2Fno_image.png?alt=media&token=964e11de-d35d-4a4a-b6b5-c3490d07c617', 2),
('CM0005', 'supicha', 'netsuwan', '0614711894', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2Fno_image.png?alt=media&token=964e11de-d35d-4a4a-b6b5-c3490d07c617', 2),
('CM0006', 'PD0004', 'XL', '0614711894', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2Fno_image.png?alt=media&token=964e11de-d35d-4a4a-b6b5-c3490d07c617', 14),
('CM0007', 'Peerapat', 'Limsoypret', '0855555555', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/profile%2F1632491138-SPzone?alt=media&token=f9ff1b0b-42f1-4e61-8aa1-bd80d64c9be0', 2),
('CM0008', 'Sp zone', 'shop', '0851111111', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/images%2Fno_image.png?alt=media&token=964e11de-d35d-4a4a-b6b5-c3490d07c617', 1);

-- --------------------------------------------------------

--
-- Table structure for table `sp_ems`
--

CREATE TABLE `sp_ems` (
  `tracking` varchar(13) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ems_or_id` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sp_ems`
--

INSERT INTO `sp_ems` (`tracking`, `ems_or_id`) VALUES
('RL207355658TH', 'OR0001'),
('RL207355658TH', 'OR0002'),
('RL207355658TH', 'OR0003'),
('ED978095487TH', 'OR0004'),
('ED978095487TH', 'OR0018'),
('ED978095487TH', 'OR0023');

-- --------------------------------------------------------

--
-- Table structure for table `sp_login`
--

CREATE TABLE `sp_login` (
  `C_customerid` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `L_email` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `L_password` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `sp_login`
--

INSERT INTO `sp_login` (`C_customerid`, `L_email`, `L_password`) VALUES
('CM0001', 'funcition@yahoo.com', 'dd4b21e9ef71e1291183a46b913ae6f2'),
('CM0002', 'funcition@yahoo.com', 'dd4b21e9ef71e1291183a46b913ae6f2'),
('CM0003', '614259004@gmail.com', 'e8a5a0fa621a443eaa76f64117380464'),
('CM0004', 'admin', '81dc9bdb52d04dc20036dbd8313ed055'),
('CM0005', '604259010@gmail.com', '495cb53167d5a9a539ddbb96451248c6'),
('CM0006', '614259000@gmail.com', '73b903b54d2b9cd843b0bafbfd4ca276'),
('CM0007', '624259032@gmail.com', '682494e09e887c5d91dad273c0ffcd2d'),
('CM0008', 'Admin', '21232f297a57a5a743894a0e4a801fc3');
...
CREATE TABLE `sp_order` (
  `Or_orderid` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `Or_date` timestamp NOT NULL DEFAULT current_timestamp(),
  `Or_price` int(11) NOT NULL,
  `C_customerid` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `OS_statusid` int(11) NOT NULL,
  `A_addressid` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `Or_imgpayment` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `Or_Pr_id` varchar(8) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `sp_order` (`Or_orderid`, `Or_date`, `Or_price`, `C_customerid`, `OS_statusid`, `A_addressid`, `Or_imgpayment`, `Or_Pr_id`) VALUES
('OR0001', '2021-08-18 07:30:34', 2820, 'CM0003', 6, 'AD0002', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1629271833-SPzone?alt=media&token=e86263ff-cef7-40ff-b43c-5c95f8bd42f9', 'PM0001'),
('OR0002', '2021-08-18 07:30:48', 2820, 'CM0003', 6, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1629271845-SPzone?alt=media&token=b2080e15-2e46-436b-95b6-285b821a8d15', 'PM0001'),
('OR0003', '2021-08-18 07:41:06', 2820, 'CM0003', 6, 'AD0002', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1629272465-SPzone?alt=media&token=8f024dc0-d8fb-4a9c-8287-c659e9b814c6', 'PM0001'),
('OR0004', '2021-08-18 08:14:44', 1850, 'CM0003', 6, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1629274480-SPzone?alt=media&token=faee862c-1c3b-4815-8726-b6d0f3d90667', 'PM0000'),
('OR0005', '2021-08-18 11:09:18', 6720, 'CM0003', 7, 'AD0005', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1629284957-SPzone?alt=media&token=5f7f132f-c504-4533-8d50-26ca6ead99cb', 'PM0001'),
('OR0006', '2021-08-18 12:32:07', 6780, 'CM0003', 7, 'AD0002', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1629289921-SPzone?alt=media&token=ca0b3d80-c18c-442e-9a62-8b4bcc495d5e', 'PM0001'),
('OR0007', '2021-08-30 10:42:21', 12720, 'CM0003', 7, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1630320140-SPzone?alt=media&token=c1e041e6-ad5a-4bb0-bbe2-4b60e86894b1', 'PM0001'),
('OR0008', '2021-08-30 11:05:01', 3020, 'CM0003', 7, 'AD0002', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1630321500-SPzone?alt=media&token=f956b58b-32ee-4a09-aa47-4a9985c3647b', 'PM0000'),
('OR0009', '2021-08-30 11:17:44', 3020, 'CM0003', 7, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1630322263-SPzone?alt=media&token=a1f8712d-a7db-4f75-b182-df84e2582a5d', 'PM0000'),
('OR0010', '2021-08-30 13:25:22', 7770, 'CM0003', 7, 'AD0008', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1630329920-SPzone?alt=media&token=459f1680-bcd2-42fb-bded-12484b39846e', 'PM0001'),
('OR0011', '2021-08-31 09:28:45', 4820, 'CM0003', 7, 'AD0008', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1630402124-SPzone?alt=media&token=b72cc4d8-87a3-4fb2-9368-74b7a4aa1446', 'PM0000'),
('OR0012', '2021-09-01 17:55:20', 6920, 'CM0003', 6, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1630518919-SPzone?alt=media&token=192314ff-3ebd-4d47-8106-04d0b75031de', 'PM0002'),
('OR0013', '2021-09-09 15:44:24', 2450, 'CM0003', 7, 'AD0007', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1631202263-SPzone?alt=media&token=de406610-8ea4-4617-93f3-8407a97f68b4', 'PM0000'),
('OR0014', '2020-09-10 02:23:47', 4185, 'CM0003', 6, 'AD0007', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1631240626-SPzone?alt=media&token=9f663982-0378-49ed-a7ff-cd007c5dce73', 'PM0003'),
('OR0015', '2021-09-20 18:35:22', 2150, 'CM0003', 6, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1632162918-SPzone?alt=media&token=aa638883-bab8-4e73-938a-0e9d54d84b1b', 'PM0000'),
('OR0016', '2021-09-21 17:46:46', 6350, 'CM0003', 6, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1632246405-SPzone?alt=media&token=c098bb79-3afb-465d-a95a-06be8382eab1', 'PM0000'),
('OR0017', '2021-09-23 19:58:04', 4850, 'CM0003', 6, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1632427082-SPzone?alt=media&token=eb839ec8-f925-4647-95c0-49bcb408b7a7', 'PM0000'),
('OR0018', '2021-09-24 13:39:55', 16020, 'CM0003', 6, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1632490794-SPzone?alt=media&token=1ae0e84d-18ca-4208-a207-48e2bcedab7b', 'PM0004'),
('OR0019', '2021-09-24 13:47:33', 6980, 'CM0007', 7, 'AD0009', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1632491252-SPzone?alt=media&token=df4c5d81-4682-47f7-a9a1-4d47fef76507', 'PM0001'),
('OR0020', '2021-09-25 05:09:36', 1040, 'CM0003', 5, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1632546575-SPzone?alt=media&token=add32381-85fe-4534-ae93-d492393b7fe7', 'PM0005'),
('OR0021', '2021-09-25 05:10:26', 1040, 'CM0003', 5, 'AD0007', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1632546625-SPzone?alt=media&token=a3ef1e6c-2cda-4050-a627-5da8543de2ee', 'PM0005'),
('OR0022', '2021-10-01 02:19:28', 2130, 'CM0003', 6, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1633054767-SPzone?alt=media&token=46df22ba-08d7-4523-819d-551f7752f3c1', 'PM0000'),
('OR0023', '2021-10-04 04:36:17', 3170, 'CM0003', 6, 'AD0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/bills%2F1633322176-SPzone?alt=media&token=c8bb065c-570b-4b0f-b837-5beb76718a5a', 'PM0000');

-- --------------------------------------------------------

--
-- Table structure for table `sp_ordertail`
--

CREATE TABLE `sp_ordertail` (
...
--
-- Dumping data for table `sp_ordertail`
--

INSERT INTO `sp_ordertail` (`Od_amount`, `P_size`, `P_productid`, `Or_orderid`) VALUES
(3, 'L', 'PD0004', 'OR0001'),
(3, 'L', 'PD0004', 'OR0002'),
(3, 'L', 'PD0004', 'OR0003'),
(3, 'XS', 'PD0002', 'OR0004'),
...
CREATE TABLE `sp_product` (
  ...
  `P_detail` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `B_brandid` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `Cg_categoryid` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `P_image1` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `P_image2` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `P_image3` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `sp_product` (`P_productid`, `P_name`, `P_price`, `P_detail`, `B_brandid`, `Cg_categoryid`, `P_image1`, `P_image2`, `P_image3`, `P_status`) VALUES
('PD0001', 'Around the bonfire Black', 700, 'Homerun collection', 'BR0015', 'CG0004', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1626939446-SPzone-Product-img1?alt=media&token=213c7edc-877b-4924-a0d7-f6d676729099', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1626939466-SPzone-Product-img1?alt=media&token=d0a46ad8-fd59-4315-a328-4c27a0354978', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1626939466-SPzone-Product-img2?alt=media&token=66bcaf78-f5b6-4856-9f1f-fcaa3c1fe073', 12),
('PD0002', 'Jone Hoodie Uzi Gun', 1300, 'yasenboy collection', 'BR0015', 'CG0006', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1626939493-SPzone-Product-img3?alt=media&token=3ec7c548-c56d-46d9-9f8c-e307a9225652', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1626939493-SPzone-Product-img2?alt=media&token=89347015-7764-4920-8c33-a342cdea0303', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1626939505-SPzone-Product-img2?alt=media&token=ff30192a-c946-4e24-a2d2-2ee7b416e52e', 12),
('PD0003', 'Dote Parnt Black spider', 1200, 'uzi collection', 'BR0013', 'CG0002', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1626939539-SPzone-Product-img1?alt=media&token=02ba12ae-8071-4759-8166-945241325e3b', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1626939539-SPzone-Product-img2?alt=media&token=a1cd355d-1938-4eb4-a4d9-e4915629278d', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1626939539-SPzone-Product-img3?alt=media&token=38e10e4d-cdea-4da4-a87f-6cd3182bf79b', 12),
('PD0004', 'Bootleg xxxTentacion ', 990, 'The First Bootleg of Brand', 'BR0014', 'CG0001', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632522913-SPzone-Product-img1?alt=media&token=1044e888-7368-4d4f-a139-bfee0f3e72ec', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632522921-SPzone-Product-img1?alt=media&token=1565ee03-4c17-44f9-a108-f220412f1b19', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632523028-SPzone-Product-img3?alt=media&token=ec2a6534-ca22-40f4-891f-44be04634ca1', 12),
('PD0005', 'A Hat Pbg', 1200, 'New Product', 'BR0012', 'CG0003', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632420886-SPzone-Product-img2?alt=media&token=42ff9789-140d-4d5a-988b-bface14aea8f', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632420886-SPzone-Product-img1?alt=media&token=f18577da-5dbb-47c9-83b5-c98a88d24bf0', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632420886-SPzone-Product-img3?alt=media&token=19101114-f285-46c8-b1c8-0a027f5e1d4c', 12),
('PD0006', 'A Gusmob 01', 500, 'New Product', 'BR0017', 'CG0004', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632420934-SPzone-Product-img1?alt=media&token=a206ffc9-cc39-4b59-8975-4f66a9c4a21a', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632420934-SPzone-Product-img2?alt=media&token=1843765e-c8eb-495c-af1e-5e79712e4b54', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632420934-SPzone-Product-img3?alt=media&token=be44ed65-27c5-4833-bd2b-8a94a6c35545', 12),
('PD0007', 'A parnt of jone', 850, 'New Product', 'BR0015', 'CG0005', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632421030-SPzone-Product-img1?alt=media&token=b41b58f2-770d-49a1-aa92-7a219dea3ef9', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632421030-SPzone-Product-img3?alt=media&token=579f14b1-3549-4557-8d4d-94e0c87470cc', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632421761-SPzone-Product-img3?alt=media&token=0577767c-a171-4441-9566-23ac313c17ea', 12),
('PD0008', 'Lalisa Bootleg', 1040, 'Lalisa collection ', 'BR0014', 'CG0001', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632521488-SPzone-Product-img1?alt=media&token=1da42e41-8c5e-4584-9458-eb340e69b665', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632521488-SPzone-Product-img2?alt=media&token=e2f6fa6d-8969-4cf2-b0ec-1190d473d9c4', 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/imagesProduct%2F1632521532-SPzone-Product-img3?alt=media&token=c8c67ec1-104d-4e76-83d7-479ee288f59f', 12);

-- --------------------------------------------------------

--
-- Table structure for table `sp_promotion`
--

CREATE TABLE `sp_promotion` (
  `Pr_promotion_code` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `Pr_time_begin` date NOT NULL,
  `Pr_time_out` date NOT NULL,
  `Pr_detail` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `Pr_sale` int(11) NOT NULL,
  `Pr_image` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `P_productid` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `Pr_amountPro` int(11) NOT NULL,
  `Pr_size` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `Pr_status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `sp_promotion`
--

INSERT INTO `sp_promotion` (`Pr_promotion_code`, `Pr_time_begin`, `Pr_time_out`, `Pr_detail`, `Pr_sale`, `Pr_image`, `P_productid`, `Pr_amountPro`, `Pr_size`, `Pr_status`) VALUES
('PM0000', '2021-08-05', '2021-09-29', 'sadsad', 0, 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/promotion%2F1630516353-SPzone?alt=media&token=1dca1123-89a8-48d9-8002-f0c3115b37d6', 'PD0001', 999, 'L', 9),
('PM0001', '2021-08-05', '2021-09-29', 'sadsad', 100, 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/promotion%2F1628094232-SPzone?alt=media&token=805fee66-6946-493f-8ade-d5771d626f60', 'PD0004', 19, 'L', 8),
('PM0002', '2021-08-30', '2021-09-05', 'sale 300.00฿ ,start 2021-08-30 - 2021-09-05 1 bill/time', 300, 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/promotion%2F1630516450-SPzone?alt=media&token=208db6a4-4860-463f-9a7b-bcf702262a5a', 'PD0003', 29, 'M', 8),
('PM0003', '2021-09-10', '2021-09-23', 'sale 35.00฿ ,start 2021-09-10 - 2021-09-23 1 bill/time', 35, 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/promotion%2F1631240529-SPzone?alt=media&token=cadba2fc-63b6-468c-b5f5-f90f48ad3740', 'PD0002', 21, 'XS', 8),
('PM0004', '2021-09-24', '2021-10-10', 'TEST', 500, 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/promotion%2F1632490643-SPzone?alt=media&token=de7ed762-87fa-4e87-9450-1ad8a1f4937f', 'PD0004', 1, 'XL', 8),
('PM0005', '2021-09-25', '2021-09-26', 'sale 50.00฿ ,start 2021-09-25 - 2021-09-26 1 bill/time', 50, 'https://firebasestorage.googleapis.com/v0/b/spzone-fb1ee.appspot.com/o/promotion%2F1632545591-SPzone?alt=media&token=3d4eba9e-9fe5-4e7a-a0c7-507dad486e81', 'PD0008', 25, 'XL', 8);

-- --------------------------------------------------------

--
-- Table structure for table `sp_size`
--

CREATE TABLE `sp_size` (
  `P_productid` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `P_size` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `P_size_amount` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `sp_size`
--

INSERT INTO `sp_size` (`P_productid`, `P_size`, `P_size_amount`) VALUES
('PD0001', 'S', 57),
('PD0001', 'L', 67),
('PD0002', 'XL', 29),
('PD0002', 'XS', 14),
...
INSERT INTO `sp_status` (`S_statusid`, `S_name`) VALUES
(1, 'admin'),
(2, 'customer'),
(3, 'active'),
(4, 'non-active'),
(5, 'wait for pay'),
(6, 'Success to confirm '),
(7, 'cancleorder'),
(8, 'inPromotion'),
(9, 'outPromotion'),
(12, 'inStock'),
...
ALTER TABLE `sp_address`
  ...
  ADD KEY `C_customerid` (`C_customerid`);

--
-- Indexes for table `sp_brand`
--
ALTER TABLE `sp_brand`
  ADD PRIMARY KEY (`B_brandid`),
...
--
ALTER TABLE `sp_cart`
  ADD PRIMARY KEY (`Ca_cartid`),
  ADD KEY `C_customerid` (`C_customerid`),
  ADD KEY `P_productid` (`P_productid`);

--
-- Indexes for table `sp_category`
--
ALTER TABLE `sp_category`
  ADD PRIMARY KEY (`Cg_categoryid`),
  ADD KEY `S_statusid` (`S_statusid`);
...
--
-- Indexes for table `sp_ems`
--
ALTER TABLE `sp_ems`
  ADD PRIMARY KEY (`ems_or_id`);

--
-- Indexes for table `sp_login`
--
ALTER TABLE `sp_login`
  ADD KEY `C_customerid` (`C_customerid`);
...
ALTER TABLE `sp_order`
  ADD PRIMARY KEY (`Or_orderid`),
  ADD KEY `C_customerid` (`C_customerid`),
  ADD KEY `S_statusid` (`OS_statusid`),
  ADD KEY `A_addressid` (`A_addressid`),
  ADD KEY `Or_Pr_id` (`Or_Pr_id`);

--
-- Indexes for table `sp_ordertail`
--
ALTER TABLE `sp_ordertail`
  ADD KEY `Or_orderid` (`Or_orderid`),
  ADD KEY `P_productid` (`P_productid`);
...
ALTER TABLE `sp_product`
  ADD PRIMARY KEY (`P_productid`),
  ADD KEY `B_brandid` (`B_brandid`),
  ADD KEY `Cg_categoryid` (`Cg_categoryid`),
  ADD KEY `P_status` (`P_status`);

--
-- Indexes for table `sp_promotion`
--
ALTER TABLE `sp_promotion`
  ADD PRIMARY KEY (`Pr_promotion_code`),
  ADD KEY `P_productid` (`P_productid`),
  ADD KEY `Pr_status` (`Pr_status`);

--
-- Indexes for table `sp_size`
--
ALTER TABLE `sp_size`
  ADD KEY `P_productid` (`P_productid`);

--
-- Indexes for table `sp_status`
--
...
--
ALTER TABLE `sp_cart`
  MODIFY `Ca_cartid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;

--
-- AUTO_INCREMENT for table `sp_status`
--
ALTER TABLE `sp_status`
  MODIFY `S_statusid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- Constraints for table `sp_address`
--
ALTER TABLE `sp_address`
  ADD CONSTRAINT `sp_address_ibfk_1` FOREIGN KEY (`C_customerid`) REFERENCES `sp_customer` (`C_customerid`);

--
-- Constraints for table `sp_brand`
--
ALTER TABLE `sp_brand`
  ADD CONSTRAINT `sp_brand_ibfk_1` FOREIGN KEY (`S_statusid`) REFERENCES `sp_status` (`S_statusid`);

--
-- Constraints for table `sp_cart`
--
ALTER TABLE `sp_cart`
  ADD CONSTRAINT `sp_cart_ibfk_1` FOREIGN KEY (`P_productid`) REFERENCES `sp_product` (`P_productid`),
  ADD CONSTRAINT `sp_cart_ibfk_2` FOREIGN KEY (`C_customerid`) REFERENCES `sp_customer` (`C_customerid`);

--
-- Constraints for table `sp_category`
--
ALTER TABLE `sp_category`
  ADD CONSTRAINT `sp_category_ibfk_1` FOREIGN KEY (`S_statusid`) REFERENCES `sp_status` (`S_statusid`);

--
-- Constraints for table `sp_customer`
--
ALTER TABLE `sp_customer`
  ADD CONSTRAINT `sp_customer_ibfk_1` FOREIGN KEY (`S_statusid`) REFERENCES `sp_status` (`S_statusid`);

--
-- Constraints for table `sp_ems`
--
ALTER TABLE `sp_ems`
  ADD CONSTRAINT `sp_ems_ibfk_1` FOREIGN KEY (`ems_or_id`) REFERENCES `sp_order` (`Or_orderid`);

--
-- Constraints for table `sp_login`
--
ALTER TABLE `sp_login`
  ADD CONSTRAINT `sp_login_ibfk_1` FOREIGN KEY (`C_customerid`) REFERENCES `sp_customer` (`C_customerid`);

--
-- Constraints for table `sp_order`
--
ALTER TABLE `sp_order`
  ADD CONSTRAINT `sp_order_ibfk_1` FOREIGN KEY (`C_customerid`) REFERENCES `sp_customer` (`C_customerid`),
  ADD CONSTRAINT `sp_order_ibfk_2` FOREIGN KEY (`OS_statusid`) REFERENCES `sp_status` (`S_statusid`),
  ADD CONSTRAINT `sp_order_ibfk_3` FOREIGN KEY (`A_addressid`) REFERENCES `sp_address` (`A_addressid`),
  ADD CONSTRAINT `sp_order_ibfk_4` FOREIGN KEY (`Or_Pr_id`) REFERENCES `sp_promotion` (`Pr_promotion_code`);

--
-- Constraints for table `sp_ordertail`
--
ALTER TABLE `sp_ordertail`
  ADD CONSTRAINT `sp_ordertail_ibfk_1` FOREIGN KEY (`Or_orderid`) REFERENCES `sp_order` (`Or_orderid`);

--
-- Constraints for table `sp_product`
--
ALTER TABLE `sp_product`
  ADD CONSTRAINT `sp_product_ibfk_1` FOREIGN KEY (`B_brandid`) REFERENCES `sp_brand` (`B_brandid`),
  ADD CONSTRAINT `sp_product_ibfk_2` FOREIGN KEY (`Cg_categoryid`) REFERENCES `sp_category` (`Cg_categoryid`),
  ADD CONSTRAINT `sp_product_ibfk_3` FOREIGN KEY (`P_status`) REFERENCES `sp_status` (`S_statusid`);

--
-- Constraints for table `sp_promotion`
--
ALTER TABLE `sp_promotion`
  ADD CONSTRAINT `sp_promotion_ibfk_1` FOREIGN KEY (`P_productid`) REFERENCES `sp_product` (`P_productid`),
  ADD CONSTRAINT `sp_promotion_ibfk_2` FOREIGN KEY (`Pr_status`) REFERENCES `sp_status` (`S_statusid`);

--
-- Constraints for table `sp_size`
--
ALTER TABLE `sp_size`
  ADD CONSTRAINT `sp_size_ibfk_1` FOREIGN KEY (`P_productid`) REFERENCES `sp_product` (`P_productid`);
COMMIT;
